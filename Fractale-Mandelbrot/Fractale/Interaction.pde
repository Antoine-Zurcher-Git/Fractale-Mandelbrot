...
void keyPressed() {
  if (HUD) {
    ...
    switch(keyCode) {
      ...
      case(38)://Haut
      x = 0;
      yc -= (echelle*height/12.0);
      break;

      case(39)://Droite
      x = 0;
      xc += (echelle*width/12.0);
      break;
  ...
  if (keyCode == 87) {//W
    ...
    jm += "-";
    saveFrame("Fractale-"+jm+int(random(10000, 99999))+"-"+str(int(parametres[0][0]))+","+str(int(parametres[0][1]))+","+str(int(parametres[1][0]))+","+str(int(parametres[1][1]))+","+str(int(parametres[2][0]))+","+str(int(parametres[2][1]))+","+str(int(parametres[2][2]))+","+str(int(parametres[3][0]))+","+str(int(parametres[3][1]))+","+str(int(parametres[3][2]))+","+str(int(parametres[4][0]*100))+","+str(int(parametres[4][1]*100))+","+str(int(parametres[5][0]))+".png");
    println("Sauvegarde");
  } else if (keyCode == 153) {//<
    String jm ="";
    if (Mandel) {
    ...
    if (enregistrerEnCSV == false) {
      saveStrings("Fractale-"+jm+int(random(10000, 99999))+"-"+str(int(parametres[0][0]))+","+str(int(parametres[0][1]))+","+str(int(parametres[1][0]))+","+str(int(parametres[1][1]))+","+str(int(parametres[2][0]))+","+str(int(parametres[2][1]))+","+str(int(parametres[2][2]))+","+str(int(parametres[3][0]))+","+str(int(parametres[3][1]))+","+str(int(parametres[3][2]))+","+str(int(parametres[4][0]*100))+","+str(int(parametres[4][1]*100))+","+str(int(parametres[5][0]))+".txt", laFractale);
    } else {
      saveTable(fractaleTable, "test.csv");
    }
    println("Sauvegarde");
  }
